...
##
"""
Write unstable hours for each generator group to a text file (stage 2 only)
"""

fp_unstable_hours = joinpath(snem2000d_dir, "results", "powerfactory", "small_signal", "unstable_hours_stage_2.txt")
...
##
"""
Make table with summary of unstable modes (stage 2 only)
"""
...
##
"""
Analysis of unstable Mainland modes (gen 1038-1043 modes)
"""
gr()  # Use GR backend for better performance
theme(:dark)

gen_1038_df = deepcopy(gdf[2] |> DataFrame)
...
# function get_gen_colour(gen_name)
#     if startswith(gen_name, "gen_1") || startswith(gen_name, "Gen 1") || startswith(gen_name, "WTG N") || startswith(gen_name, "PV N")
#         return "blue"
#     elseif startswith(gen_name, "gen_2") || startswith(gen_name, "Gen 2") || startswith(gen_name, "WTG V") || startswith(gen_name, "PV V")
#         return "green"
#     elseif startswith(gen_name, "gen_3") || startswith(gen_name, "Gen 3") || startswith(gen_name, "WTG Q") || startswith(gen_name, "PV Q")
#         return "red"
#     elseif startswith(gen_name, "gen_4") || startswith(gen_name, "Gen 4") || startswith(gen_name, "WTG S") || startswith(gen_name, "PV S")
#         return "yellow"
#     elseif startswith(gen_name, "gen_5") || startswith(gen_name, "Gen 5") || startswith(gen_name, "WTG T") || startswith(gen_name, "PV T")
#         return "purple"
#     else
#         throw(ArgumentError("Unknown generator name: $gen_name"))
#     end
# end
...
##
"""
Analysis of tasmania modes (gdf[2], gdf[3], gdf[5])
"""
gr()  # Use GR backend for better performance
theme(:dark)

gen_5033_df = deepcopy(gdf[1] |> DataFrame)
...
##
mode_summary_df.hour |> unique |> sort
tas_hours = vcat(
                gdf[1].hour,
                gdf[4].hour,
                gdf[6].hour
