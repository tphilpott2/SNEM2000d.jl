...
function add_gen_graphical_data!(output_dfs, bus_connection_dict, bus_xy_dict)
    ...
    symnams = Dict(
        ...
        "wind_generator" => "d_genstat",
        "type_3_wind_generator_vsr" => "d_genstat",
        "type_4A_wind_generator_vsr" => "d_genstat",
        "type_4B_wind_generator_vsr" => "d_genstat",
        "type_3_wind_generator" => "d_genstat",
        "type_4A_wind_generator" => "d_genstat",
        "type_4B_wind_generator" => "d_genstat",
        "static_generator" => "d_genstat",
        "pv_generator" => "d_pvsys",
        "pv_generator_vsr" => "d_pvsys",
